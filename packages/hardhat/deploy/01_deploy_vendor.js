...
module.exports = async ({getNamedAccounts, deployments}) => {
  ...
  /* Owner set on deploy (construct) more secure to avoid front run
  console.log("\n 🤹  Sending ownership to frontend address...\n")
  const ownershipTransaction = await vendor.transferOwnership("0xec53aA9A368fb06C0b0F95B211FdAe516943CeC9");
  console.log("\n    ✅ confirming...\n");
